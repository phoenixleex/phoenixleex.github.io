...
function PointCollection() {
    ...
    this.update = function () {
        for (var i = 0; i < this.points.length; i++) {
            ...
            point.targetPos.x = d < 38 ? point.curPos.x - dx : point.originalPos.x;
            point.targetPos.y = d < 38 ? point.curPos.y - dy : point.originalPos.y;
        ...
        if (document.alphabet.hasOwnProperty(cc_hex)) {
            ...
            for (var i = 0; i < chr_data.length; ++i) {
                ...
                g.push(new Point(point[0] * fontSizeMultiplier  + offset,
                    ...
                    0.0,
                    point[2] * (fontSizeMultiplier + 0.1),
